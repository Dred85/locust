...
## 🎨 Визуальный редактор профилей нагрузки

### Установка и запуск

```bash
# 1. Установи зависимости для редактора
...
- ✅ **Визуализация графика** нагрузки в реальном времени
- ✅ **Добавление/редактирование** этапов нагрузки
- ✅ **Удаление** ненужных этапов
- ✅ **Перемещение** этапов (вверх/вниз)
- ✅ **Выбор User Classes** для каждого этапа
- ✅ **Статистика** - общая длительность, максимум пользователей
- ✅ **Предпросмотр кода** перед сохранением
...
```
┌─────────────────────────────────────────────────────────────────┐
│  Этапы нагрузки              │  График нагрузки                 │
│                              │                                  │
│  1. 0-20s | Users: 20  ...   │      80 ┤                        │
│  2. 20-40s | Users: 40 ...   │         │              ╭─────    │
│  3. 40-60s | Users: 60 ...   │      60 ┤         ╭────╯         │
│  ...                         │         │    ╭────╯              │
│                              │      40 ┤╭───╯                   │
│  [➕ Добавить] [✏️ Редактир.] │         │                        │
│  [❌ Удалить] [⬆️] [⬇️]       │      20 ┼╯                       │
│                              │         └────────────────────    │
│  Статистика:                 │         0   60  120  180  240    │
│  Этапов: 8                   │              Время (сек)         │
│  Длительность: 300 сек       │                                  │
│  Максимум: 80 пользователей  │                                  │
│                              │                                  │
│  [💾 Сохранить] [👁️ Просмотр] │                                  │
└─────────────────────────────────────────────────────────────────┘
```
